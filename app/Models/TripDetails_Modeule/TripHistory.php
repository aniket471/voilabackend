...
class TripHistory extends Model
{
    ...
    public static function getMidLatLng($request)
    {
        ...
        $getLatLng = self::select(self::rider_pickup_lat, self::rider_pickup_long)->where(self::rider_id, 6)->get();
        ...
        $routeChangePoint = self::select(self::rider_pickup_lat, self::rider_pickup_long)->where(self::rider_id, 6)->first();
        ...
        $calculateTheDistanceMidToEnd = DriverVehicles::routeChangedCalculate($routeChangePoint[self::rider_pickup_lat], $routeChangePoint[self::rider_pickup_long], $request[self::rider_dest_lat], $request[self::rider_dest_long]);
