...
class DriverRegistrationRequiredDocsModel extends Model
{
    ...
    public static function getAllDriverRequiredDocs(){
        ...
        $data = ["Driver Details Required Docs"=>$driverRegistrationDetails,"Driver Address Required Docs"=>$driverAddressDocsDetails,
                 "Driver KYC Required Docs"=>$driverKYCDocsDetails, "Driver Vehicle Required Docs"=>$driverVehicleDetails];
    ...
    public static function getAllRestaurantRequiredDocs(){
        ...
        $data = ["Restaurant Owner Required Docs"=>$restaurantOwnerRequiredDocs,"Restaurant Details Required Docs"=>$restaurantDetailsRequiredDocs];
